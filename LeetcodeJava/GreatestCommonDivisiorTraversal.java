...
public class GreatestCommonDivisiorTraversal {
    ...
    public void allprime(int n, HashMap<Integer, ArrayList<Integer>> map, int st) {
        while (n % 2 == 0) {
    ...
    public static void main(String[] args) {
        // Example usage
        int[] nums = {6, 10, 15};
        GreatestCommonDivisiorTraversal solution = new GreatestCommonDivisiorTraversal();
